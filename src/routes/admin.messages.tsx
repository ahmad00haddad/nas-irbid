  ...
  return (
    <div>
      ...
      {isLoading ? <p className="text-muted-foreground text-sm">جاري التحميل…</p> :
       data.length === 0 ? <div className="text-center p-12 rounded-2xl bg-card border border-dashed border-border"><p className="text-muted-foreground">لا رسائل بعد.</p></div> : (
